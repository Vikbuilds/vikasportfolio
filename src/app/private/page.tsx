...
export default function PrivateSpacePage() {
  ...
  useEffect(() => {
    ...
    if (savedStatus === "true") {
      ...
      // If accessed directly without unlocking from the starting modal, redirect home
      router.push("/");
    }
  }, [router]);
  ...
  return (
    <>
      <Navbar />
      <main className="mx-auto w-full max-w-xl px-5 pb-32 pt-8 font-private-grotesk">
        <div className="space-y-8">
          ...
          >
            ...
            {/* STAGE 3: PHILOSOPHY LINE IN PP EDITORIAL FONT */}
